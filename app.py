...
if st.session_state.current_page == "About":
    ...
    with col1:
        st.markdown(f"""
        <div class='team-bio'>
            <img src='data:image/jpeg;base64,{base64.b64encode(open('swathi.png', 'rb').read()).decode()}' class='circular-img'>
            <div class='card'>
                <h4>Swathi</h4>
    ...
    with col2:
        st.markdown(f"""
        <div class='team-bio'>
            <img src='data:image/jpeg;base64,{base64.b64encode(open('sejal.png', 'rb').read()).decode()}' class='circular-img'>
            <div class='card'>
                <h4>Sejal</h4>
    ...
    with col3:
        st.markdown(f"""
        <div class='team-bio'>
            <img src='data:image/jpeg;base64,{base64.b64encode(open('chithira.png', 'rb').read()).decode()}' class='circular-img'>
            <div class='card'>
                <h4>Chithira</h4>
                <p><strong>Role:</strong> Theory & Content Lead</p>
